          ...
          <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
            ...
            <div className="hs-dropdown relative inline-flex [--trigger:hover]">
              <button
                ...
                type="button"
                className="hs-dropdown-toggle py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-400 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none"
              >
                Categories
                <svg
